...
| `output.splitOutput`             | Membagi output menjadi beberapa file bernomor berdasarkan ukuran maksimum per bagian. Saat menggunakan CLI, tentukan ukuran yang dapat dibaca seperti `500kb` atau `2mb`. Ini menjaga setiap file di bawah batas dan menghindari pemisahan file antar bagian | Tidak diatur |
