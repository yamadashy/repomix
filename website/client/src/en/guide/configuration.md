...
| `output.originalLineNumbers`     | Whether to add line numbers to original content before processing. When true, line numbers are added before any transformations | `false`                |
