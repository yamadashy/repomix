...
If you have [Nix](https://nixos.org/download) with flakes enabled, you can enter a reproducible development shell with Node.js and Git pre-installed (versions matching `.tool-versions`):
