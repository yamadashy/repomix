...
| `output.splitOutput`             | Dividir saída em múltiplos arquivos numerados por tamanho máximo por parte. Ao usar CLI, especifique tamanhos legíveis como `500kb` ou `2mb`. Isso mantém cada arquivo abaixo do limite e evita dividir arquivos entre partes | Não definido |
