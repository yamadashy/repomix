...
Se você tem [Nix](https://nixos.org/download) com flakes habilitados, pode entrar em um shell de desenvolvimento reproduzível com Node.js e Git pré-instalados (versões correspondentes a `.tool-versions`):
