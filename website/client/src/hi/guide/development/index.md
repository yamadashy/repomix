...
यदि आपके पास [Nix](https://nixos.org/download) flakes सक्षम है, तो आप Node.js 24 और Git के साथ पहले से इंस्टॉल किए गए पुन: प्रस्तुत करने योग्य विकास शेल में प्रवेश कर सकते हैं:
