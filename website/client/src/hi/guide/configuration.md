...
| `input.processors`               | `{ pattern, command, timeout?, onError? }` प्रविष्टियों का एक क्रमबद्ध एरे जो पैकिंग से पहले मेल खाने वाली फ़ाइलों को रूपांतरित करने के लिए एक बाहरी कमांड चलाता है (उदा., JSON→TOON)। पहला मेल खाने वाला glob जीतता है। यह मनमाने कमांड चलाता है, इसलिए यह केवल लोकल CLI रन के लिए सक्षम है। देखें [फ़ाइल प्रोसेसर्स](#फ़ाइल-प्रोसेसर्स) | सेट नहीं |
...
- वे केवल local CLI रन (अपनी मशीन पर `repomix` चलाना) के लिए सक्षम हैं, जहां trust boundary npm scripts या Makefile के समान है।
- वे library API (`pack()` / `runCli()`), MCP सर्वर, और होस्टेड [repomix.com](https://repomix.com) के लिए **अक्षम** हैं।
- रिमोट रिपॉजिटरी (`--remote`) के लिए, क्लोन की गई रिपॉजिटरी के कॉन्फ़िग पर तभी भरोसा किया जाता है जब `--remote-trust-config` भी पास किया गया हो।

सक्रिय प्रोसेसर्स को स्टार्टअप पर लॉग किया जाता है ताकि किसी अपरिचित कॉन्फ़िग से अप्रत्याशित प्रोसेसर्स दिखाई दे सकें।
:::

नोट्स:

- किसी प्रोसेसर को उसी फ़ाइल पर `output.compress` (या `output.patterns` के `compress`) के साथ जोड़ना अनुशंसित नहीं है: रूपांतरित सामग्री अब अपनी मूल भाषा के रूप में पार्स नहीं हो सकती। कम्प्रेशन best-effort है और पार्स विफलता पर चुपचाप रूपांतरित सामग्री पर वापस चला जाता है।
