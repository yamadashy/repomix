...
| `output.splitOutput`             | अधिकतम आकार प्रति भाग के अनुसार आउटपुट को कई नंबर वाली फ़ाइलों में विभाजित करें। CLI का उपयोग करते समय, `500kb` या `2mb` जैसे पठनीय आकार निर्दिष्ट करें। यह प्रत्येक फ़ाइल को सीमा के अंदर रखता है और फ़ाइलों को भागों में विभाजित करने से बचाता है | सेट नहीं |
