...
2. `.repomixignore`
3. `.ignore` (यदि `ignore.useDotIgnore` true है और `--no-dot-ignore` उपयोग नहीं किया गया है)
4. `.gitignore` और `.git/info/exclude` (यदि `ignore.useGitignore` true है और `--no-gitignore` उपयोग नहीं किया गया है)
5. डिफ़ॉल्ट पैटर्न (यदि `ignore.useDefaultPatterns` true है और `--no-default-patterns` उपयोग नहीं किया गया है)
