...
| `--remote-trust-config` | रिमोट रिपॉजिटरी से कॉन्फ़िग फ़ाइलों को विश्वसनीय मानें और लोड करें। भरोसेमंद कॉन्फ़िग कमांड चला सकता है और स्थानीय फ़ाइलें पढ़ सकता है, इसलिए इसका उपयोग केवल उन्हीं रिपॉजिटरी के लिए करें जिन पर आप पूरी तरह भरोसा करते हैं (सुरक्षा के लिए डिफ़ॉल्ट रूप से अक्षम) |
