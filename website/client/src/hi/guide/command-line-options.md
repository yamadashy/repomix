...
- `--stat`: प्रति-फ़ाइल परिवर्तन गणना दिखाएं (git log --stat)
- `--patch`: पंक्ति-दर-पंक्ति diffs दिखाएं (git log --patch)
- `--numstat`: प्रति फ़ाइल संख्यात्मक जोड़/हटाव दिखाएं (git log --numstat)
- `--shortstat`: परिवर्तनों का एक-पंक्ति सारांश दिखाएं (git log --shortstat)
- `--dirstat`: डायरेक्टरी परिवर्तन वितरण दिखाएं (git log --dirstat)
- `--name-only`: केवल फ़ाइल नाम दिखाएं (git log --name-only) - डिफ़ॉल्ट
- `--name-status`: A/M/D/R स्थिति के साथ फ़ाइल नाम दिखाएं (git log --name-status)
- `--raw`: SHA हैश और मोड के साथ निम्न-स्तरीय फ़ॉर्मेट दिखाएं (git log --raw)

**आउटपुट विस्तार और ग्राफ़ विकल्प** (किसी भी diff फ़ॉर्मेट के साथ संयोजनीय):
- `--graph`: ASCII और Mermaid कमिट ग्राफ़ विज़ुअलाइज़ेशन शामिल करें (git log --graph --all)
- `--summary`: फ़ाइल संचालन जैसे निर्माण, नाम बदलना, मोड परिवर्तन दिखाएं (git log --summary)
