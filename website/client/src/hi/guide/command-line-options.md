...
- `--no-dot-ignore`: .ignore फ़ाइल उपयोग अक्षम करें
...
## Git कमिट इतिहास विकल्प

विस्तृत नियंत्रण के लिए ये फ्लैग git log की संरचना को दर्शाते हैं:

**Diff फ़ॉर्मेट फ्लैग** (परस्पर अनन्य - एक चुनें):
- `--git-stat`: प्रति-फ़ाइल परिवर्तन गणना दिखाएं (git log --stat)
- `--git-patch`: पंक्ति-दर-पंक्ति diffs दिखाएं (git log --patch)
- `--git-numstat`: प्रति फ़ाइल संख्यात्मक जोड़/हटाव दिखाएं (git log --numstat)
- `--git-shortstat`: परिवर्तनों का एक-पंक्ति सारांश दिखाएं (git log --shortstat)
- `--git-dirstat`: डायरेक्टरी परिवर्तन वितरण दिखाएं (git log --dirstat)
- `--git-name-only`: केवल फ़ाइल नाम दिखाएं (git log --name-only) - डिफ़ॉल्ट
- `--git-name-status`: A/M/D/R स्थिति के साथ फ़ाइल नाम दिखाएं (git log --name-status)
- `--git-raw`: SHA हैश और मोड के साथ निम्न-स्तरीय फ़ॉर्मेट दिखाएं (git log --raw)

**आउटपुट विस्तार और ग्राफ़ विकल्प** (किसी भी diff फ़ॉर्मेट के साथ संयोजनीय):
- `--git-graph`: ASCII और Mermaid कमिट ग्राफ़ विज़ुअलाइज़ेशन शामिल करें (git log --graph --all)
- `--git-summary`: फ़ाइल संचालन जैसे निर्माण, नाम बदलना, मोड परिवर्तन दिखाएं (git log --summary)
- `--commit-range <range>`: विश्लेषण के लिए Git कमिट रेंज (डिफ़ॉल्ट: HEAD~50..HEAD, .. और ... दोनों सिंटैक्स समर्थित, उदा: "HEAD~100..HEAD", "v1.0..v2.0", "main...feature-branch")
