...
यह समझना महत्वपूर्ण है कि MCP सर्वर क्या सुरक्षित करता है और क्या नहीं, क्योंकि यह तय करना कि किस टूल को किन आर्ग्युमेंट्स के साथ कॉल करना है, आपका नहीं बल्कि AI एजेंट का निर्णय होता है।

- **टूल्स वह सब कुछ पढ़ सकते हैं जो प्रोसेस पढ़ सकती है।** `pack_codebase` को दिया गया कोई भी पूर्ण डायरेक्टरी पथ पैकेज कर देता है, और पैकेज्ड आउटपुट एजेंट को वापस दे दिया जाता है। यह किसी प्रोजेक्ट रूट तक सीमित नहीं है; सीमा केवल आपके ऑपरेटिंग सिस्टम की फ़ाइल अनुमतियाँ हैं।
- **सीक्रेट स्कैनिंग एक ह्यूरिस्टिक है, एक्सेस कंट्रोल नहीं।** [Secretlint](https://github.com/secretlint/secretlint) ज्ञात क्रेडेंशियल फ़ॉर्मेट्स से मेल खाने वाली फ़ाइलों को बाहर रखता है (उदाहरण के लिए AWS कीज़ और प्राइवेट कीज़)। यह हर सीक्रेट को नहीं पहचानता, इसलिए `~/.netrc` या kubeconfig जैसी फ़ाइलें इससे होकर गुज़र सकती हैं। एक साफ़ स्कैन को "कुछ स्पष्ट नहीं मिला" समझें, "यह साझा करना सुरक्षित है" नहीं।
- **एजेंट को उसके द्वारा पढ़ी गई सामग्री से प्रभावित किया जा सकता है।** यदि यह किसी अविश्वसनीय रिपॉजिटरी का विश्लेषण करता है, तो उस रिपॉजिटरी में मौजूद टेक्स्ट इसे किसी संवेदनशील डायरेक्टरी को पैकेज करने या किसी असंबंधित URL को क्लोन करने के लिए निर्देशित करने की कोशिश कर सकता है। Repomix क्लाउड इंस्टेंस मेटाडेटा एंडपॉइंट्स को क्लोन करने से इनकार करता है, लेकिन यह किसी वास्तविक अनुरोध और इंजेक्ट किए गए अनुरोध के बीच अंतर नहीं कर सकता।

MCP सर्वर को केवल उन्हीं एजेंट्स और रिपॉजिटरीज़ से कनेक्ट करें, जिन्हें आप इस स्तर की पहुंच देने के लिए तैयार हैं।
...
4. **उन्नत सुविधाएं**: कोड संपीड़न, टोकन गिनती, और सीक्रेट स्कैनिंग जैसी Repomix की सभी सुविधाओं का लाभ उठाता है।
