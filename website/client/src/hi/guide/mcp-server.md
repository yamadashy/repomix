...
उपरोक्त उदाहरण के साथ (`compress: true` ग्लोबल डिफ़ॉल्ट के रूप में), `src/core/` के अंतर्गत फ़ाइलें पूर्ण सामग्री में रखी जाती हैं, `docs/` के अंतर्गत फ़ाइलें केवल डायरेक्टरी संरचना में सूचीबद्ध होती हैं, और बाकी सब कुछ संपीड़ित किया जाता है।
