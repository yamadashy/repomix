...
> [!NOTE]
> В целях безопасности конфигурационные файлы удалённых репозиториев по умолчанию не загружаются. Чтобы доверять конфигурации удалённого репозитория, добавьте `remoteTrustConfig: true` в параметры.
