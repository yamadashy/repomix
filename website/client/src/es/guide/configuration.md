...
| `output.splitOutput`             | Dividir la salida en múltiples archivos numerados por tamaño máximo por parte. Al usar CLI, especifique tamaños legibles como `500kb` o `2mb`. Esto mantiene cada archivo bajo el límite y evita dividir archivos entre partes | No establecido |
