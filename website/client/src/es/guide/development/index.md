...
Si tienes [Nix](https://nixos.org/download) con flakes habilitados, puedes entrar en un shell de desarrollo reproducible con Node.js y Git preinstalados (versiones que coinciden con `.tool-versions`):
